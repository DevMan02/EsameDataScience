...
grand_chalem <- formula_frames  %>%
  filter(pilota_piu_veloce_gara == vincitore_gara_Monza & vincitore_gara_Monza == pilota_piu_veloce_qualifica) %>% #conto quante volte il pilota che ha vinto monza poi ha vinto il campionato
  summarise(conteggio = n())
